...
void ImGui::TableBeginApplyRequests(ImGuiTable* table)
{
    ...
    if (table->InstanceCurrent == 0)
    {
        ...
        // Process auto-fit for single column, which is a other case for stretch columns and fixed columns with FixedSame policy.
...
void ImGui::TableUpdateLayout(ImGuiTable* table)
{
    ...
    for (int order_n = 0; order_n < table->ColumnsCount; order_n++)
    {
        ...
        // Draw Enabled state, mark settings and sort specs dirty
...
void    ImGui::EndTable()
{
    ...
    // Draw ColumnsAutoFitWidth to get us ahead for host using our size to auto-resize without waiting for next BeginTable()
...
void ImGui::TableEndRow(ImGuiTable* table)
{
    ...
    if (is_visible)
    {
        // Draw data for TableGetHoveredRow()
    ...
    if (unfreeze_rows_actual)
    {
        ...
        // Draw cliprect ahead of TableBeginCell() so clipper can access to new ClipRect->Min.y
...
void ImGui::TableSaveSettings(ImGuiTable* table)
{
    ...
    // BindFrameBuffer or create settings data
    ImGuiContext& g = *GImGui;
